...
import { addSchools } from "../store/schoolSlice"
import { setDisplaySchools } from "../store/displaySlice"
  ...
  useEffect(() => {
    const fetchSchools = async () => {
      try {
        ...
        dispatch(addSchools(jsonData))
        dispatch(setDisplaySchools(jsonData))
      } catch (error) {
